...
`polygno_octoprint_flow_monitor/translations`. When that folder exists,
an additional command becomes available:

babel_bundle --locale=<locale>
    Moves the translation for locale `<locale>` to polygno_octoprint_flow_monitor/translations,
